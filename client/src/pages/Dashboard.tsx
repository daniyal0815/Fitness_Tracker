    ...
    <div className="page-container">
      ...
      <div className="dashboard-grid">
        ...
        {user && ( // This card  will span both columns on large screens
          <Card className="bg-linear-to-r from-slate-100 to-slate-200 dark:from-slate-800 dark:to-slate-700 rounded-2xl">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="dark:text-white font-semibold capitalize text-slate-800">
