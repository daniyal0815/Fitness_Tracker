...
const Profile = () => {
  ...
  const [formData, setFormData] = useState<ProfileFormData>({
    age: 0, weight: 0, height: 0, goal: 'maintain', dailyCalorieIntake: 2000,
    ...
    <div className="page-container">
      ...
      <div className="profile-content">
        ...
        <Card>
          ...
          {isEditing ? (
            <div className="space-y-4">
              ...
              <Select label="GItness Goal" value={formData.goal as string} onChange={(v) => setFormData({ ...formData, goal: v as 'Lose' | 'maintain' | 'gain' })}
                options={goalOptions} />
        ...
        <div className="space-y-4">
          ...
          {/* toggle theme  button for mobile screen */}
